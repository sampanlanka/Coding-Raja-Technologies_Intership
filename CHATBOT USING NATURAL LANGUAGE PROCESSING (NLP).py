...
file= open('C:\\Users\\SampanPatrudu\\Downloads\\CBT.txt', 'r', errors='ignore')
rawdata = file.read()
...
    flag = True
    print("Hello, there my name is JARVIS. I will answer your queries. If you want to quit, type Bye!")
    while(flag==True):
        user_response = input()
...
        else:
            flag = False
            print("JARVIS: Bye! Have a great time!" )